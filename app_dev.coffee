...
exports.init = (app)=>
  ...
  app.get '/d/c.css', (req, res)-> res.sendFile(__dirname+'/public/d/css/screen.css')
  app.get '/d/screen.css.map', (req, res)-> res.sendFile(__dirname+'/public/d/css/screen.css.map')
